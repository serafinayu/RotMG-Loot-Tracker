...
const ItemContextProvider = (props) => {
    ...
    const categories = {
        "weapons": ["daggers", "dual blades", "bows", 'longbows', 
            'staves', 'spellblades', 'wands', 'morning stars', 
            'swords', 'flails', 'katanas', 'tachis'],
        "abilities": ['cloaks', 'quivers', 'spells', 'tomes', 
            'helms', 'shields', 'seals', 'poisons', 
            'skulls', 'traps', 'orbs', 'prisms', 'scepters', 
            'stars', 'wakizashi', 'lutes', 'maces', 'sheaths'],
        "armor": ['leather', 'robes', 'heavy'],
        "rings": ['health', 'magic', 'attack', 'defense', 'speed', 
            'dexterity', 'vitality', 'wisdom', 'untiered', 'limited' ]
    }
    ...
    // const [selectedCollection, setSelectedCollection] = useState(collections[collectionId]);
    const [selectedCollectionId, setSelectedCollectionId] = useState(Object.keys(collections)[0])
    const [selectedCollection, setSelectedCollection] = useState(collections[selectedCollectionId]);
    ...
    const applyFilter = useCallback(async () => {
        ...
        const filteredItems = Object.entries(items).filter(([itemId, item]) => {
            ...
            if (showObtained && !Object.prototype.hasOwnProperty.call(obtainedItems, itemId)) {
    ...
    }, [category, subCategory, showObtained, search, selectedCollection, collections]);
    ...
    const value = {
        ...
        tieredItems, utItems, stItems, shinyItems,
        applyFilter, showObtained, setShowObtained,
        resetFilters, selectedItem, setSelectedItem,
        search, setSearch,
